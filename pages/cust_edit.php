...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold " style="color:#012241;">Edit Customer</h4>
            </div><a  type="button" class="btn  btn-block" style="background-color:#012241;color:white" href="customer.php?"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
            <div class="card-body">
